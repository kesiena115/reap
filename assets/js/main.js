...
$(document).ready(function() {
  ...
  $('#resource-main-panel').on('mouseover', '.article-inner', function() {
    $(this).addClass('highlighted-article')
  });
  
  $('#resource-main-panel').on('mouseout', '.article-inner', function() {
    if ($(this).hasClass('highlighted-article')) {
			$(this).removeClass('highlighted-article');
    }
  });
  ...
  $('#our-team, #reap-initiatives-container').on('mouseover', '.person-holder', function() {
    ...
    pc.toggleClass('red-reap');
    pc.toggleClass('dark-blue-reap');
  });
  ...
  $.fn.toggleReapInfo = function() {
    if($('#more-reap-info-div').css('display') === 'none') {
      $('#more-reap-info-spinner').css('display','block');
      $('#more-reap-info-div').load('./more_reap_info.html', function(){
        $('#more-reap-info-div').slideDown();
        $('#more-reap-info-spinner').css('display','none');
      });
      $('#reap-info-toggle').html('Less<span class="dropup"><span class="caret"></span></span>')
    } else {
      $('#more-reap-info-div').slideUp().empty();
      $('#reap-info-toggle').html('More<span class="caret"></span>')
    }
    return this;
  }
  
  $.fn.toggleArticles = function() {
    if($('#more-articles-div').css('display') === 'none') {
      $('#more-articles-spinner').css('display','block');
      $('#more-articles-div').load('./more_articles.html', function(){
        $('#more-articles-div').slideDown();
      });
      $('#more-publications-div').load('./more_publications.html', function(){
        $('#more-publications-div').slideDown();
        $('#more-articles-spinner').css('display','none');
      });
       $('#articles-toggle').html('Less<span class="dropup"><span class="caret"></span></span>')
    } else {
      $('#more-articles-div').slideUp().empty();
      $('#more-publications-div').slideUp().empty();
      $('#articles-toggle').html('More<span class="caret"></span>')
    }
    return this;
  }
  
  $.fn.toggleReapNews = function() {
    if($('#more-faculty-news-div').css('display') === 'none') {
      $('#more-reap-news-spinner').css('display','block');
      $('#more-faculty-news-div').load('./more_faculty_news.html', function(){
        $('#more-faculty-news-div').slideDown();
      });
      $('#more-teams-news-div').load('./more_teams_news.html', function(){
        $('#more-teams-news-div').slideDown();
        $('#more-reap-news-spinner').css('display','none');
      });
      $('#news-toggle').html('Less<span class="dropup"><span class="caret"></span></span>')
    } else {
      $('#more-faculty-news-div').slideUp().empty();
      $('#more-teams-news-div').slideUp().empty();
      $('#news-toggle').html('More<span class="caret"></span>')
    }
    return this;
  }
  
  $.fn.toggleInitiatives = function() {
    if($('#more-initiatives-div').css('display') === 'none') {
      $('#more-initiatives-spinner').css('display','block');
      $('#more-initiatives-div').load('./more_initiatives.html', function(){
        $('#more-initiatives-div').slideDown();
      });
      $('#more-teaching-div').load('./more_teaching.html', function(){
        $('#more-teaching-div').slideDown();
      });
      $('#more-faculty-div').load('./more_faculty.html', function(){
        $('#more-faculty-div').slideDown();
        $('#more-initiatives-spinner').css('display','none');
      });
      $('#initiatives-toggle').html('Less<span class="dropup"><span class="caret"></span></span>')
    } else {
      $('#more-initiatives-div').slideUp().empty();
      $('#more-teaching-div').slideUp().empty();
      $('#more-faculty-div').slideUp().empty();
      $('#initiatives-toggle').html('More<span class="caret"></span>')
    }
    return this;
  }
  ...
  $('#reap-info-toggle, .reap-info-header').click(function(event) {
   ...
   $('#articles-toggle, .articles-header').click(function(event) {
    event.preventDefault();
    $(this).toggleArticles();
  })
  
  $('#news-toggle, .news-header').click(function(event) {
    event.preventDefault();
    $(this).toggleReapNews();
  })
